...
namespace Patches
{
	namespace Network
	{
		...
		public:
			...
			virtual void ApplyData(int playerIndex, Players::PlayerProperties *properties, const void *data) = 0;
		...
		protected:
			...
			// Applies extension data to a player.
			virtual void ApplyData(int playerIndex, Players::PlayerProperties *properties, const TData &data) = 0;
		...
		public:
			...
			void ApplyData(int playerIndex, Players::PlayerProperties *properties, const void *data) override
			{
		...
		public:
			...
			void ApplyData(int playerIndex, Players::PlayerProperties *properties, const void *data);
