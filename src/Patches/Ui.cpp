...
#include "../Blam/Tags/MultilingualUnicodeStringList.hpp"
...
namespace Patches
{
	namespace Ui
	{
		...
		void ApplyUIResolution()
		{
			...
			Blam::Tags::ChudDefinition* spartanChud = Blam::Tags::GetTag<Blam::Tags::ChudDefinition>(0x0C1E);
			Blam::Tags::ChudDefinition* eliteChud = Blam::Tags::GetTag<Blam::Tags::ChudDefinition>(0xE5F);
		...
		void SetSpeakingPlayer(std::string speakingPlayer)
		{
			...
			using Blam::Tags::MultilingualUnicodeStringList;
			using Blam::Tags::ChudDefinition;

			if (speakingPlayer.length() > 15) // player names are limited to 15 anyway.
				return;

			Blam::Tags::MultilingualUnicodeStringList* unic = Blam::Tags::GetTag<Blam::Tags::MultilingualUnicodeStringList>(0x12c2);
			...
			{
				Blam::Tags::ChudDefinition* chud = Blam::Tags::GetTag<Blam::Tags::ChudDefinition>(0x12BD);
		...
		void UpdateVoiceChatHUD()
		{
			...
			Blam::Tags::ChudDefinition* scoreboardChud = Blam::Tags::GetTag<Blam::Tags::ChudDefinition>(0x12BD);
			Blam::Tags::ChudDefinition* spartanChud = Blam::Tags::GetTag<Blam::Tags::ChudDefinition>(0x0C1E);
			Blam::Tags::ChudDefinition* eliteChud = Blam::Tags::GetTag<Blam::Tags::ChudDefinition>(0xE5F);
